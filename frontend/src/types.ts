...
export type Task = { task_uid: string; title: string; topic_uid: string; is_done: boolean; deadline: string | null; priority: "LOW" | "MEDIUM" | "HIGH" };
export type Session = { study_uid: string; subject_uid: string; started_at: string; duration_minutes: number | null; notes: string | null };
